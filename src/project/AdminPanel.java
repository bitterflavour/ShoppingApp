...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        checkStockButton.setText("Inventory");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(checkStockButton, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(billingButton, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        stockStatusCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptops", "Mobiles", "Tablets" }));
        ...
        delUpdateCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptops", "Mobiles", "Tablets" }));
        ...
        checkStockPanelLayout.setHorizontalGroup(
            ...
            .addGroup(checkStockPanelLayout.createSequentialGroup()
                ...
                .addGroup(checkStockPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(updateStockButton, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(delEntry, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(59, 59, 59))
        );
        checkStockPanelLayout.setVerticalGroup(
            ...
            .addGroup(checkStockPanelLayout.createSequentialGroup()
                ...
                .addGroup(checkStockPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(delEntry, javax.swing.GroupLayout.Alignment.TRAILING))
        ...
        updatePanel.add(mPhotoPath, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 380, 210, 30));
        ...
        updatePanel.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 80, 140, -1));

        mCat.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        mCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptops", "Mobile", "Tablets" }));
        ...
        updatePanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 110, 370, 190));
        ...
        updatePanel.add(selectedPhoto, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 330, 230, 210));
        ...
        updatePanel.add(photoSelection, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 430, 50, 30));
        ...
        updatePanel.add(LogInButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 510, 130, 50));
    ...
    private void checkStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkStockButtonActionPerformed
            ...
            ArrayList<ProductList> list = LaptopsDB.checkStock();
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        ...
        else if(mCat.getSelectedItem().equals("Laptops")){
            if(!path.equals(""))
                LaptopsDB.insertIntoLaptopsDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        else if(mCat.getSelectedItem().equals("Tablets")){
            if(!path.equals(""))
                TabletsDB.insertIntoTabletsDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
    ...
    private void updateStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStockButtonActionPerformed
       ...
       try{
            ...
            if(stockStatusCat.getSelectedItem().equals("Laptops")){
                LaptopsDB.flag = true;
                LaptopsDB.updateLaptopsDB(model, qty);
            }
            ...
            else if(stockStatusCat.getSelectedItem().equals("Tablets")){
                TabletsDB.flag = true;
                TabletsDB.updateTabletsDB(model, qty);
            }
    ...
    private void delEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delEntryActionPerformed
        ...
        if(delUpdateCat.getSelectedItem().equals("Laptops")){
            LaptopsDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Mobiles")){
            MobileDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Tablets")){
            TabletsDB.delete(del);
        }
